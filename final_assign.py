...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unem_rate= recession_data.groupby('Vehicle_Type')['unemployment_rate'].sum().reset_index()
        R_chart4 = dcc.Graph(
            figure= px.bar(unem_rate,
                           x='Vehicle_Type',
                           y='unemployment_rate',
                           title='Effect of umemployment rate on vehicle type and sales'
                            )
        )
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        avr_vdata=yearly_data.groupby(['Month','Vehicle_Type'])['Automobile_Sales'].sum().reset_index()
